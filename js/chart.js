   ...
   var myChart4a = echarts.init(document.getElementById("container4a"));
   var myChart4b = echarts.init(document.getElementById("container4b"));
   var myChart4c = echarts.init(document.getElementById("container4c"));
   var myChart5 = echarts.init(document.getElementById("container5"));
   var myChart6 = echarts.init(document.getElementById("container6"));
   var myChart7 = echarts.init(document.getElementById("container7"));
   var myChart7a = echarts.init(document.getElementById("container7a"));
   var myChart7b = echarts.init(document.getElementById("container7b"));
     var myChart7c = echarts.init(document.getElementById("container7c"));
       var myChart7d = echarts.init(document.getElementById("container7d"));
   var myChart8 = echarts.init(document.getElementById("container8"));
   var myChart8a = echarts.init(document.getElementById("container8a"));
   var myChart11 = echarts.init(document.getElementById("container11"));
   var myCharta11 = echarts.init(document.getElementById("myCharta11"));
  ...
  myChart6.setOption({
    ...
    legend: {
        orient: 'vertical',
        x: 'left',
        data:['Direct','Marketing advertising','search engine','Email marketing','Alliance advertising','Video ad','Baidu','Google','must','other']
    },
    series: [
        {
            name:'Access source',
  ...
  myChart7.setOption({
	title: {
        text: 'Medical Interventions Breakdown',
    ...
    yAxis: {
        type: 'category',
        data: [ 'Pending/Undecided', 'Non-occupational', 'Medical treatment', 'First aid']
    },
    series: [
        {
            name: 'year 2011',
  ...
  myChart7a.setOption({
    ...
    yAxis: {
        type: 'category',
        data: [ 'Work Site D', 'Work Site C', 'Work Site B', 'Work Site A']
    },
    series: [
        {
            name: 'year 2011',
  ...
  myChart7b.setOption({
    title: {
        text: 'First-aid Interventions Breakdown',
        subtext: 'Data from the network'
    },
    tooltip: {
        trigger: 'axis',
    ...
    yAxis: {
        type: 'category',
        data: [ 'Tetanus vaccinie', 'FB removal from eye', 'No treatment necessary', 'Non-Rigid Support', 'Wound Dressing', 'Wound Cleansing', 'Hot/Cold Therapy', 'OTC Medication']
    },
    series: [
        {
            name: 'year 2011',
   ...
   myChart7c.setOption({
    ...
    yAxis: {
        type: 'category',
        data: [ 'Employee', 'Onsite Medical', 'Supervisor', 'Other']
    },
    series: [
        {
            name: 'year 2011',
  ...
  myChart7d.setOption({
    title: {
        text: 'Most Frequent Injuries - Top 5',
        subtext: 'Data from the network'
    },
    tooltip: {
        trigger: 'axis',
    ...
    yAxis: {
        type: 'category',
        data: [ 'Sprain/Strain', 'Musculoskeletal', 'Cut/Laceration', 'Abrasion/Scratch']
    },
    series: [
        {
            name: 'year 2011',
  ...
  myChart8.setOption({
     title: {
            text: 'Flow of modalities by encounter'
        },
	color: [
    ...
    dataset: {
        ...
        source: [
            {product: 'Telemedicine', '2015': 43.3, '2016': 85.8},
            {product: 'DTP', '2015': 83.1, '2016': 73.4},
            {product: 'Telemedicine 3', '2015': 46.4, '2016': 55.2},
            {product: 'DTP 1', '2015': 36.4, '2016': 65.2},
            {product: 'DTP 3', '2015': 26.4, '2016': 65.2},
            {product: 'Telemedicine 06', '2015': 86.4, '2016': 65.2},
            {product: 'Telemedicine 05', '2015': 72.4}
        ]
    },
    xAxis: {type: 'category'},
    yAxis: {},
  ...
  myChart11.setOption({
   tooltip : {
    ...
    legend: {
        data:['direct access', 'mail marketing', 'alliance ad', 'video ad', 'search engine', 'Baidu', 'Google', 'Bing', 'Other']
    },
    grid: {
        left: '3%',
        right: '4%',
    ...
    xAxis : [
        {
            type : 'category',
            data : ['Telemedicine', 'DTP', 'Wednesday', ]
        }
    ],
    yAxis : [
        {
